...
const CustomCursor = () => {
  ...
  return (
    <>
      <motion.div
        className="fixed top-0 left-0 w-10 h-10 border border-blue-400/70 rounded-full pointer-events-none z-[9999] shadow-[0_0_15px_rgba(96,165,250,0.6)] hidden md:block"
        animate={{
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-2 h-2 bg-blue-400 rounded-full pointer-events-none z-[10000] shadow-[0_0_10px_rgba(96,165,250,0.9)] hidden md:block"
        animate={{
          x: mousePosition.x - 4,
          y: mousePosition.y - 4,
        }}
